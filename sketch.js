...
var ballImg,robot,playerImg,playerFall;
function preload(){
  ...
  playerFall=loadImage("playerFall.png");
}
...
function draw() {  
  ...
  if (ball.x < 0) {
      ...
      computerScore++;
      userPaddle.addImage(playerFall);
    }
